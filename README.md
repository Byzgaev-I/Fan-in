...
![image](https://github.com/Byzgaev-I/Fan-in/blob/main/Снимок%20экрана%202025-12-04%20в%2017.00.07.png)


### Программа реализует паттерн Fan-in для объединения метрик от трёх  независимых источников данных:  

- cpuMetrics: 5 метрик с интервалом 800 мс (диапазон 0-100)  
- memoryMetrics: 5 метрик с интервалом 1200 мс (диапазон 0-16384)  
- networkMetrics: 5 метрик с интервалом 1500 мс (диапазон 0-1000)  

Функция fanIn объединяет все источники через sync.WaitGroup.  
Программа выводит ровно 15 метрик и корректно завершается.  

Протестировал: go run main.go  

### Все метрики выведены, программа завершена успешно.  
